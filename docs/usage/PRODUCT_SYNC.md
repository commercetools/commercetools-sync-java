...
When syncing from a source commercetools project, you can use [`toProductDrafts`](https://github.com/commercetools/commercetools-sync-java/blob/java-sdk-v2-product-sync-migration/src/main/java/com/commercetools/sync/products/utils/ProductTransformUtils.java#L59)
...
[here](https://github.com/commercetools/commercetools-sync-java/blob/java-sdk-v2-product-sync-migration/src/test/java/com/commercetools/sync/products/utils/ProductSyncUtilsTest.java).
...
For client creation use [ClientConfigurationUtils](https://github.com/commercetools/commercetools-sync-java/blob/java-sdk-v2-product-sync-migration/src/main/java/com/commercetools/sync/commons/utils/ClientConfigurationUtils.java) which apply the best practices for `ProjectApiRoot` creation.
...
If you sync products between different commercetools projects you probably use [ProductTransformUtils#toProductDrafts](https://github.com/commercetools/commercetools-sync-java/blob/java-sdk-v2-product-sync-migration/src/main/java/com/commercetools/sync/products/utils/ProductTransformUtils.java#L59) to transform `ProductProjection` into `ProductDraft` which can be used by the product-sync.
