...
2. Changing the attribute definition type is not supported. Instead, remove and re-add it with a new type manually. For more information please [check](../../docs/adr/0003-syncing-attribute-type-changes.md).
