...
references, those `key`s have to be supplied in the following way:
    ...
    reference would return its `key`. 
        ...
        **Note**: When syncing from a source commercetools project, you can use this util which this library provides: 
         [`replaceProductTypesReferenceIdsWithKeys`](https://commercetools.github.io/commercetools-sync-java/v/1.8.1/com/commercetools/sync/producttypes/utils/ProductTypeReferenceReplacementUtils.html#replaceProductTypesReferenceIdsWithKeys-java.util.List-)
