...
When syncing from a source commercetools project, you can use [`toStateDrafts`](https://commercetools.github.io/commercetools-sync-java/v/8.1.1/com/commercetools/sync/states/utils/StateTransformUtils.html#toStateDrafts-java.util.List-)
