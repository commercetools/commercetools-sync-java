...
When syncing from a source commercetools project, you can use [`toStateDrafts`](https://commercetools.github.io/commercetools-sync-java/v/9.0.3/com/commercetools/sync/states/utils/StateTransformUtils.html#toStateDrafts-java.util.List-)
