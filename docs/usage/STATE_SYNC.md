...
When syncing from a source commercetools project, you can use [`toStateDrafts`](https://commercetools.github.io/commercetools-sync-java/v/7.0.1/com/commercetools/sync/states/utils/StateTransformUtils.html#toStateDrafts-java.util.List-)
