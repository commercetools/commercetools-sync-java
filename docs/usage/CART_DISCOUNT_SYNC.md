...
`Type` has to be supplied in the following way:
   ...
   **Note**: When syncing from a source commercetools project, you can use this util which this library provides:
    [`replaceCartDiscountsReferenceIdsWithKeys`](https://commercetools.github.io/commercetools-sync-java/v/1.8.0/com/commercetools/sync/cartdiscounts/utils/CartDiscountReferenceReplacementUtils.html#replaceCartDiscountsReferenceIdsWithKeys-java.util.List-)
