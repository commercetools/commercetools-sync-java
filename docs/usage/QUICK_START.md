...
````groovy
// Add commercetools-jvm-sdk dependencies.
implementation 'com.commercetools.sdk.jvm.core:commercetools-models:1.56.0'
implementation 'com.commercetools.sdk.jvm.core:commercetools-java-client:1.56.0'
