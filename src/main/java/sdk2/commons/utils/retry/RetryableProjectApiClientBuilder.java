package sdk2.commons.utils.retry;
...
import sdk2.commons.utils.ClientConfig;
...
public final class RetryableProjectApiClientBuilder extends Base {
    ...
    private RetryableProjectApiClientBuilder(
            ...
            @Nonnull final VrapHttpClient httpClient) {
     ...
     */
    public RetryableProjectApiClientBuilder withStatusCodesToRetry(final List<Integer> statusCodesToRetry) {
