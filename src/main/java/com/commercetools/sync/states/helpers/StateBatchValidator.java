...
public class StateBatchValidator
    ...
    public StateBatchValidator(@Nonnull final StateSyncOptions syncOptions,
     ...
     * and return an {@link ImmutablePair}&lt;{@link Set}&lt;{@link StateDraft}&gt;
     * ,{@link Set}&lt;{@link String}&gt;&gt;
     * which contains the {@link Set} of valid drafts and referenced state transition keys.
     *
    ...
    public ImmutablePair<Set<StateDraft>, Set<String>> validateAndCollectReferencedKeys(
        ...
        final Set<StateDraft> validDrafts = stateDrafts
            .stream()
    ...
    private boolean isValidStateDraft(
        @Nullable final StateDraft stateDraft,
        @Nonnull final Set<String> stateTransitionKeys) {
