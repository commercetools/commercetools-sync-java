...
public class ProductSyncStatistics extends BaseSyncStatistics {
     ...
     *
     * <p>"Summary: 2 products were processed in total (0 created, 0 updated and 0 products failed to sync)."
     *
    ...
    public String getReportMessage() {
        reportMessage = format(
            "Summary: %s products were processed in total (%s created, %s updated and %s products failed to sync).",
