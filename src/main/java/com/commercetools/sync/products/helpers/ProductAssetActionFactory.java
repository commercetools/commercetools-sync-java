...
public  final class  ProductAssetActionFactory<R extends Product, D extends ProductDraft>
    ...
    @Override
    public <D> List<UpdateAction<Product>> buildAssetActions(
    ...
    @Override
    public UpdateAction<Product> buildChangeAssetOrderAction(@Nonnull final List<String> newAssetOrder) {
        return ChangeAssetOrder.ofVariantId(variantId, newAssetOrder, true);
    }

    @Override
    public UpdateAction<Product> buildAddAssetAction(@Nonnull final AssetDraft assetDraft,
                                                     @Nonnull final Integer position) {
        return AddAsset.ofVariantId(variantId, assetDraft)
