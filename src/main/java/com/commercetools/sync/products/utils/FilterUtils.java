...
public final class FilterUtils {
  ...
  /**
   * Given a {@link com.commercetools.sync.products.SyncFilter}, a {@link
   * com.commercetools.sync.products.ActionGroup} and 2 {@link Supplier}. This method checks if the
   * action group passes the criteria of the syncFiler, i.e. either of the following cases:
   *
   * <ul>
   *   <li>The {@link com.commercetools.sync.products.SyncFilter} is null.
   *   <li>Passes the {@link com.commercetools.sync.products.SyncFilter}.
   * </ul>
   *
