...
public class ResourceKeyIdGraphQlRequest implements SphereRequest<ResourceKeyIdGraphQlResult> {
   ...
   * It provides a POST request to the CTP graphql API containing body to fetch a set of ids
   * matching given keys of a resource defined in endpoint parameter.
   *
