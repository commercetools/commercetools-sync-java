    ...
    private CompletionStage<Optional<String>> getCustomTypeId(@Nonnull final CustomFieldsDraft custom,
        ...
        try {
            ...
            final String errorMessage =
                format("%s Reason: %s", referenceResolutionErrorMessage, referenceResolutionException.getMessage());
            return exceptionallyCompletedFuture(
                    new ReferenceResolutionException(errorMessage, referenceResolutionException));
        }
    }
