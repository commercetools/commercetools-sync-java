...
public final class ClientConfigurationUtils {
    ...
    /**
     * Creates a {@link SphereClient} with retry logic which computes a exponential backoff time delay in milliseconds.
     *
    ...
    /**
     * Gets an asynchronous {@link HttpClient} of `asynchttpclient` library,
     * to be used by as an underlying http client for the {@link SphereClient}.
     *
