...
public final class CustomTypeReferenceResolutionUtils {
  ...
  /**
   * Given a resource of type {@code T} that extends {@link
   * com.commercetools.sync.commons.models.Custom} (i.e. it has {@link CustomFields}, this method
   * checks if the custom fields are existing (not null) and they are reference cached(reference
   * idToKey value stored in the map). If they are then it returns a {@link CustomFieldsDraft}
   * instance with the custom type key in place of the key of the reference. Otherwise, if it's not
   * reference cached it returns a {@link CustomFieldsDraft} without the key. If the resource has
   * null {@link com.commercetools.sync.commons.models.Custom}, then it returns {@code null}.
   *
   ...
   *     has no or null {@link com.commercetools.sync.commons.models.Custom}, then it returns {@code
   *     null}.
   */
  @Nullable
   ...
   * do not extends {@link com.commercetools.sync.commons.models.Custom}. If the custom fields are
   * existing (not null) and they are reference cached(reference idToKey value stored in the map).
   * If they are then it returns a {@link CustomFieldsDraft} instance with the custom type key in
   * place of the key of the reference. Otherwise, if it's not reference cached it returns a {@link
   * CustomFieldsDraft} without the key. If the resource has null {@link
   * com.commercetools.sync.commons.models.Custom}, then it returns {@code null}.
   *
