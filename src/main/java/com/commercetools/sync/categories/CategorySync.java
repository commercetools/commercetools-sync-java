...
public class CategorySyncImpl implements Sync {
    ...
    @Override
    public <T extends CustomDraft> void syncDrafts(@Nonnull final List<T> categoryDrafts) {
    ...
    @Override
    public <T extends Custom> void sync(@Nonnull final List<T> categories) {
