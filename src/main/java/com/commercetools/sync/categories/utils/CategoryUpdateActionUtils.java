...
public final class CategoryUpdateActionUtils {
   ...
   * If both the {@link Category} and the {@link CategoryDraft} have the same name, then no update
  ...
  public static Optional<UpdateAction<Category>> buildChangeNameUpdateAction(
    ...
    return buildUpdateAction(
        oldCategory.getName(), newCategory.getName(), () -> ChangeName.of(newCategory.getName()));
  }

  /**
   * Compares the {@link LocalizedString} slugs of a {@link Category} and a {@link CategoryDraft}
   * and returns an {@link UpdateAction}&lt;{@link Category}&gt; as a result in an {@link Optional}.
   * If both the {@link Category} and the {@link CategoryDraft} have the same slug, then no update
   * action is needed and hence an empty {@link Optional} is returned.
   *
   * @param oldCategory the category which should be updated.
  ...
  public static Optional<UpdateAction<Category>> buildChangeSlugUpdateAction(
      @Nonnull final Category oldCategory, @Nonnull final CategoryDraft newCategory) {
    return buildUpdateAction(
        oldCategory.getSlug(), newCategory.getSlug(), () -> ChangeSlug.of(newCategory.getSlug()));
  }

  /**
   * Compares the {@link LocalizedString} descriptions of a {@link Category} and a {@link
   * CategoryDraft} and returns an {@link UpdateAction}&lt;{@link Category}&gt; as a result in an
   * {@link Optional}. If both the {@link Category} and the {@link CategoryDraft} have the same
  ...
  public static Optional<UpdateAction<Category>> buildChangeParentUpdateAction(
    ...
    if (newParent == null && oldParent != null) {
      ...
      return buildUpdateActionForReferences(
          oldParent, newParent, () -> ChangeParent.of(ResourceIdentifier.ofId(newParent.getId())));
    }
  }

  /**
   * Compares the orderHint values of a {@link Category} and a {@link CategoryDraft} and returns an
   * {@link UpdateAction}&lt;{@link Category}&gt; as a result in an {@link Optional}. If both the
   * {@link Category} and the {@link CategoryDraft} have the same orderHint, then no update action
   * is needed and hence an empty {@link Optional} is returned.
   *
   * <p>Note: If the orderHint of the new {@link CategoryDraft} is null, an empty {@link Optional}
   * is returned with no update actions and a custom callback function, if set on the supplied
   * {@link CategorySyncOptions}, is called.
   *
   * @param oldCategory the category which should be updated.
  ...
  /**
   * Compares the {@link LocalizedString} meta title of a {@link Category} and a {@link
   * CategoryDraft} and returns an {@link UpdateAction}&lt;{@link Category}&gt; as a result in an
   * {@link Optional}. If both the {@link Category} and the {@link CategoryDraft} have the same meta
   * title, then no update action is needed and hence an empty {@link Optional} is returned.
   *
   * @param oldCategory the category which should be updated.
  ...
  /**
   * Compares the {@link LocalizedString} meta keywords of a {@link Category} and a {@link
   * CategoryDraft} and returns an {@link UpdateAction}&lt;{@link Category}&gt; as a result in an
   * {@link Optional}. If both the {@link Category} and the {@link CategoryDraft} have the same meta
  ...
  /**
   * Compares the {@link LocalizedString} meta description of a {@link Category} and a {@link
   * CategoryDraft} and returns an {@link UpdateAction}&lt;{@link Category}&gt; as a result in an
   * {@link Optional}. If both the {@link Category} and the {@link CategoryDraft} have the same meta
   * description, then no update action is needed and hence an empty {@link Optional} is returned.
   *
   ...
   * {@link UpdateAction}&lt;{@link Category}&gt; as a result in an {@link Optional}. If both the
   * {@link Category} and the {@link CategoryDraft} have the same externalId, then no update action
   * is needed and hence an empty {@link Optional} is returned.
   *
   * @param oldCategory the category which should be updated.
   ...
   * {@link UpdateAction}&lt;{@link Category}&gt; as a result. If both the {@link Category} and the
   * {@link CategoryDraft} have the identical assets, then no update action is needed and hence an
   * empty {@link List} is returned. In case, the new category draft has a list of assets in which a
   * duplicate key exists, the error callback is triggered and an empty list is returned.
   *
   * @param oldCategory the category which should be updated.
   * @param newCategory the category draft where we get the new externalId.
