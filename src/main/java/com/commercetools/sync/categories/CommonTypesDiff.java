...
public class CommonTypesDiff {
     ...
     */
    @Nonnull
    public static <T> Optional<UpdateAction<T>> buildUpdateAction(@Nullable final Object existingObject,
                                                                  @Nullable final Object newObject,
                                                                  @Nullable final UpdateAction<T> updateAction) {
        return !Objects.equals(existingObject, newObject) && updateAction != null
