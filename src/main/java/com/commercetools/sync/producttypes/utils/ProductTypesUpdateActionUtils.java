...
public final class ProductTypesUpdateActionUtils {

    /**
     * Compares the {@code key} values of a {@link ProductType} and a {@link ProductTypeDraft}
     ...
     * @param newProductType the product type draft which contains the new key
     * @return optional containing update action or empty optional if keys are identical
     */
    @Nonnull
    public static Optional<UpdateAction<ProductType>> buildSetKeyAction(@Nonnull final ProductType
                                                                                   oldProductType,
                                                                           @Nonnull final ProductTypeDraft
                                                                                   newProductType) {
        return buildUpdateAction(oldProductType.getKey(), newProductType.getKey(),
            () -> SetKey.of(newProductType.getKey()));
    }
     ...
     */
    @Nonnull
    public static Optional<UpdateAction<ProductType>> buildChangeNameAction(@Nonnull final ProductType
                                                                                oldProductType,
                                                                        @Nonnull final ProductTypeDraft
                                                                                newProductType) {
     ...
     */
    @Nonnull
    public static Optional<UpdateAction<ProductType>> buildChangeDescriptionAction(@Nonnull final ProductType
                                                                                    oldProductType,
                                                                            @Nonnull final ProductTypeDraft
                                                                                    newProductType) {
