...
public final class ClientConfig extends Base {
  ...
  public static ClientConfig of(
      final String projectKey, final String clientId, final String clientSecret) {
  ...
  public static ClientConfig of(
    ...
    return new ClientConfig(
        projectKey, clientId, clientSecret, authUrl, apiUrl, CorrelationIdGenerator.of(projectKey));
  }
