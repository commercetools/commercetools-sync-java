...
import static com.commercetools.sync.sdk2.inventories.utils.InventorySyncUtils.buildActions;
...
import com.commercetools.sync.sdk2.commons.utils.CompletableFutureUtils;
import com.commercetools.sync.sdk2.inventories.helpers.InventoryBatchValidator;
import com.commercetools.sync.sdk2.inventories.helpers.InventoryEntryIdentifier;
import com.commercetools.sync.sdk2.inventories.helpers.InventoryReferenceResolver;
...
public final class InventorySync
  ...
  private CompletionStage<Optional<InventoryEntry>> buildActionsAndUpdate(
    ...
    final List<InventoryEntryUpdateAction> updateActions = buildActions(entry, draft, syncOptions);
