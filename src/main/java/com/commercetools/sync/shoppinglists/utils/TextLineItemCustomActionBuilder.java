...
public final class TextLineItemCustomActionBuilder implements GenericCustomActionBuilder<ShoppingList> {
    ...
    public UpdateAction<ShoppingList> buildSetCustomTypeAction(
        ...
        return SetTextLineItemCustomType.ofTypeIdAndJson(customTypeId, customFieldsJsonMap, textLineItemId);
    }
