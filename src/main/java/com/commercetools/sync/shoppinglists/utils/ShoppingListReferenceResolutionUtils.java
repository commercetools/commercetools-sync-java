...
public final class ShoppingListReferenceResolutionUtils {
  ...
  @Nullable
  private static List<LineItemDraft> mapToLineItemDrafts(@Nullable final List<LineItem> lineItems) {
   ...
   * <ul>
   *   <li>Customer
   *   <li>Custom Type of the Shopping List
   *   <li>Variants of the LineItems
   *   <li>Custom Types of the LineItems
   *   <li>Custom Types of the TextLineItems
   * </ul>
   *
   ...
   * source project.
   *
   * @return the query for fetching shopping lists from the source CTP project with all the
