...
public final class AddLineItemWithSku extends UpdateActionImpl<ShoppingList>
    implements CustomDraft {

  @Nullable private final String sku;
  @Nullable private final Long quantity;
  @Nullable private final ZonedDateTime addedAt;
  @Nullable private final CustomFieldsDraft custom;
