...
public interface TypeService {
     ...
     * @return {@link CompletableFuture}&lt;{@link Map}&gt; in which the result of it's completion contains a map of
     *      requested type keys -&gt; ids
     */
    @Nonnull
    CompletableFuture<Map<String, String>> cacheKeysToIds(@Nonnull final Set<String> typeKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedTypeId(@Nonnull String key);
     ...
     * @return {@link CompletableFuture}&lt;{@link Map}&gt; in which the result of its completion contains a {@link Set}
     *          of all matching Types.
     */
    @Nonnull
    CompletableFuture<Set<Type>> fetchMatchingTypesByKeys(@Nonnull Set<String> keys);
     ...
     * @return {@link CompletableFuture}&lt;{@link Optional}&gt; in which the result of its completion contains an
     *         {@link Optional} that contains the matching {@link Type} if exists, otherwise empty.
     */
    @Nonnull
    CompletableFuture<Optional<Type>> fetchType(@Nullable String key);
     ...
     * key are cached and the method returns a {@link CompletableFuture} in which the result of its completion
     ...
     */
    @Nonnull
    CompletableFuture<Optional<Type>> createType(@Nonnull TypeDraft typeDraft);
     ...
     * {@link CompletableFuture}&lt;{@link Type}&gt; in which the result of its completion contains an instance of
     ...
     * @return {@link CompletableFuture}&lt;{@link Type}&gt; containing as a result of it's completion an instance of
     *         the {@link Type} which was updated in the CTP project or a {@link io.sphere.sdk.models.SphereException}.
     */
    @Nonnull
    CompletableFuture<Type> updateType(@Nonnull Type type,
