...
public interface TypeService {
     ...
     * an injected {@link io.sphere.sdk.client.SphereClient}. The created type's id and key are also
     ...
     * issues an update request with these update actions on this {@link Type} in the CTP project defined in an injected
     * {@link io.sphere.sdk.client.SphereClient}. This method returns {@link CompletionStage}&lt;{@link Type}&gt; in
     * which the result of it's completion contains an instance of the {@link Type} which was updated in the CTP
     * project.
     *
