...
public interface InventoryService {
     ...
     */
    @Nonnull
    CompletableFuture<Set<InventoryEntry>> fetchInventoryEntriesBySkus(
     ...
     * @return {@link CompletableFuture} with created {@link InventoryEntry} or an exception
     */
    @Nonnull
    CompletableFuture<Optional<InventoryEntry>> createInventoryEntry(
     ...
     * @return {@link CompletableFuture} with updated {@link InventoryEntry} or an exception
     */
    @Nonnull
    CompletableFuture<InventoryEntry> updateInventoryEntry(
