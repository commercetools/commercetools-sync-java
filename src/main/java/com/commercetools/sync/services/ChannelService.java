...
public interface ChannelService {
     ...
     */
    @Nonnull
    CompletableFuture<Map<String, String>> cacheKeysToIds(@Nonnull final Set<String> channelKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedChannelId(@Nonnull String key);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<Channel>> createChannel(@Nonnull final String key);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<Channel>> createAndCacheChannel(@Nonnull final String key);
}
