...
public interface TaxCategoryService {
     ...
     */
    @Nonnull
    CompletableFuture<Map<String, String>> cacheKeysToIds(@Nonnull final Set<String> taxCategoryKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedTaxCategoryId(@Nullable final String key);
     ...
     */
    @Nonnull
    CompletableFuture<Set<TaxCategory>> fetchMatchingTaxCategoriesByKeys(@Nonnull final Set<String> keys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<TaxCategory>> fetchTaxCategory(@Nullable final String key);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<TaxCategory>> createTaxCategory(@Nonnull final TaxCategoryDraft taxCategoryDraft);
     ...
     * {@link CompletableFuture}&lt;{@link TaxCategory}&gt; in which the result of it's completion contains an instance
     ...
     * @return {@link CompletableFuture}&lt;{@link TaxCategory}&gt; containing as a result of it's completion an instance
     *         of the {@link TaxCategory} which was updated in the CTP project or a
     *         {@link io.sphere.sdk.models.SphereException}.
     */
    @Nonnull
    CompletableFuture<TaxCategory> updateTaxCategory(@Nonnull final TaxCategory taxCategory,
