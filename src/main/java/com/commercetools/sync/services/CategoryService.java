...
public interface CategoryService {
     ...
     */
    @Nonnull
    CompletableFuture<Map<String, String>> cacheKeysToIds(@Nonnull final Set<String> categoryKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Set<Category>> fetchMatchingCategoriesByKeys(@Nonnull Set<String> categoryKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<Category>> fetchCategory(@Nullable String key);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedCategoryId(@Nonnull String key);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<Category>> createCategory(@Nonnull CategoryDraft categoryDraft);
     ...
     * {@link CompletableFuture}&lt;{@link Category}&gt; in which the result of it's completion contains an instance of
     ...
     * @return {@link CompletableFuture}&lt;{@link Category}&gt; containing as a result of it's completion an instance of
     *         the {@link Category} which was updated in the CTP project or a
     *         {@link io.sphere.sdk.models.SphereException}.
     */
    @Nonnull
    CompletableFuture<Category> updateCategory(@Nonnull Category category,
