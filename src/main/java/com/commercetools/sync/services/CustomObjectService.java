...
public interface CustomObjectService {
     ...
     * If it contains, it returns a {@link CompletableFuture}&lt;{@link Optional}&lt;{@link String}&gt;&gt;
     ...
     * a {@link CompletableFuture}&lt;{@link Optional}&lt;{@link String}&gt;&gt;
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedCustomObjectId(@Nonnull CustomObjectCompositeIdentifier identifier);
     ...
     */
    @Nonnull
    CompletableFuture<Set<CustomObject<JsonNode>>> fetchMatchingCustomObjects(
     ...
     */
    @Nonnull
    CompletableFuture<Optional<CustomObject<JsonNode>>> fetchCustomObject(
     ...
     * {@link CompletableFuture} in which the result of its completion contains an instance {@link Optional} of the
     ...
     * @return a {@link CompletableFuture} containing an optional with the created/updated resource if successful
     *     otherwise an empty optional.
     */
    @Nonnull
    CompletableFuture<Optional<CustomObject<JsonNode>>> upsertCustomObject(
