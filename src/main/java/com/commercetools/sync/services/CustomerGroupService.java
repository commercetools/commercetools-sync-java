...
public interface CustomerGroupService {
     ...
     *      requested customer group keys -&gt; ids
     */
    @Nonnull
    CompletableFuture<Map<String, String>> cacheKeysToIds(@Nonnull final Set<String> customerGroupKeys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<String>> fetchCachedCustomerGroupId(@Nullable String key);
}
