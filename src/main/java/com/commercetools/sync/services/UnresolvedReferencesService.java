...
public interface UnresolvedReferencesService {
     ...
     */
    @Nonnull
    CompletableFuture<Set<WaitingToBeResolved>> fetch(@Nonnull final Set<String> keys);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<WaitingToBeResolved>> save(@Nonnull final WaitingToBeResolved draft);
     ...
     */
    @Nonnull
    CompletableFuture<Optional<WaitingToBeResolved>> delete(@Nonnull final String key);
}