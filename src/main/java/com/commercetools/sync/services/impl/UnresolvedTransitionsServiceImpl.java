...
public class UnresolvedTransitionsServiceImpl implements UnresolvedTransitionsService {
  ...
  @Nonnull
  @Override
  public CompletionStage<Set<WaitingToBeResolvedTransitions>> fetch(
    ...
    final CustomObjectQuery<WaitingToBeResolvedTransitions> customObjectQuery =
        CustomObjectQuery.of(WaitingToBeResolvedTransitions.class)
  ...
  public CompletionStage<Optional<WaitingToBeResolvedTransitions>> save(
    ...
    final CustomObjectDraft<WaitingToBeResolvedTransitions> customObjectDraft =
  ...
  @Nonnull
  @Override
  public CompletionStage<Optional<WaitingToBeResolvedTransitions>> delete(
    ...
    return syncOptions
        ...
        .execute(
            CustomObjectDeleteCommand.of(
                CUSTOM_OBJECT_CONTAINER_KEY, hash(key), WaitingToBeResolvedTransitions.class))
        .handle(
            (resource, exception) -> {
              if (exception == null) {
                return Optional.of(resource.getValue());
