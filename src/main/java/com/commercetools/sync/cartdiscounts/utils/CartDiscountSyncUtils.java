...
public final class CartDiscountSyncUtils {
     ...
     * {@link UpdateAction}&lt;{@link CartDiscount}&gt; as a result. If no update action is needed, for example in
     * case where both the {@link CartDiscount} and the {@link CartDiscountDraft} have the same fields, an empty
     ...
     *                    on the build update action process. And other options (See {@link CartDiscountSyncOptions}
     *                    for more info.
    ...
    public static List<UpdateAction<CartDiscount>> buildActions(
        ...
        final List<UpdateAction<CartDiscount>> updateActions = filterEmptyOptionals(
