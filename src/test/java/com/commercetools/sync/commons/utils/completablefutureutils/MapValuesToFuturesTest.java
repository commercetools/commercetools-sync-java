...
class MapValuesToFuturesTest {
  ...
  void empty_StreamToList_ReturnsEmptyList() {
    final List<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.<String>empty(), CompletableFuture::completedFuture, toList());
  ...
  void empty_StreamToSet_ReturnsEmptySet() {
    final Set<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.<String>empty(), CompletableFuture::completedFuture, toSet());
    assertThat(futures).isEmpty();
  }
  ...
  void singleNull_StreamToList_ReturnsEmptyList() {
    ...
    final List<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.of(nullString), CompletableFuture::completedFuture, toList());
    assertThat(futures).isEmpty();
  }
  ...
  void singleNull_StreamToSet_ReturnsEmptySet() {
    final String nullString = null;
    final Set<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.of(nullString), CompletableFuture::completedFuture, toSet());
    assertThat(futures).isEmpty();
  }
  ...
  /**
   * * Stream to List : Same Type Mapping : Single Value. * Stream to Set : Same Type Mapping :
   * Single Value. * Stream to List : Diff Type Mapping : Single Value. * Stream to Set : Diff Type
   * Mapping : Single Value.
   */
  @Test
  ...
  void single_StreamToSetWithDiffTypeMapping_ReturnsSetOfMappedValue() {
    final Set<CompletableFuture<Integer>> futures =
        mapValuesToFutures(Stream.of("foo"), element -> completedFuture(element.length()), toSet());
  ...
  /**
   * * Stream to List : Same Type Mapping : Multiple Values : no duplicates. * Stream to Set : Same
   * Type Mapping : Multiple Values : no duplicates. * Stream to List : Diff Type Mapping : Multiple
   * Values : no duplicates. * Stream to Set : Diff Type Mapping : Multiple Values : no duplicates.
   */
  @Test
  void multiple_StreamToListWithSameTypeMappingNoDuplicates_ReturnsListOfMappedValues() {
    ...
    final List<String> results = futures.stream().map(CompletableFuture::join).collect(toList());
  ...
  void multiple_StreamToListWithDiffTypeMappingNoDuplicates_ReturnsListOfMappedValues() {
    ...
    final List<Integer> results = futures.stream().map(CompletableFuture::join).collect(toList());
  ...
  void multiple_StreamToSetWithDiffTypeMappingNoDuplicates_ReturnsSetOfMappedValues() {
    final Set<CompletableFuture<Integer>> futures =
        mapValuesToFutures(
            Stream.of("john", "smith"), element -> completedFuture(element.length()), toSet());
  ...
  /**
   * * Stream to List : Same Type Mapping : Multiple Values : duplicates. * Stream to Set : Same
   * Type Mapping : Multiple Values : duplicates. * Stream to List : Diff Type Mapping : Multiple
   * Values : duplicates. * Stream to Set : Diff Type Mapping : Multiple Values : duplicates.
   */
  @Test
  void
      multiple_StreamToListWithSameTypeMappingDuplicates_ReturnsListOfMappedValuesWithDuplicates() {
    final List<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.of("john", "john"), CompletableFuture::completedFuture, toList());
  ...
  void multiple_StreamToSetWithSameTypeMappingDuplicates_ReturnsSetOfMappedValuesDuplicates() {
    final Set<CompletableFuture<String>> futures =
        mapValuesToFutures(Stream.of("john", "john"), CompletableFuture::completedFuture, toSet());
  ...
  @Test
  void
      multiple_StreamToListWithDiffTypeMappingDuplicates_ReturnsListOfMappedValuesWithDuplicates() {
    final List<CompletableFuture<Integer>> futures =
        mapValuesToFutures(
  ...
  void multiple_StreamToSetWithDiffTypeMappingDuplicates_ReturnsSetOfMappedValuesWithDuplicates() {
    final Set<CompletableFuture<Integer>> futures =
        mapValuesToFutures(
            Stream.of("john", "john"), element -> completedFuture(element.length()), toSet());
