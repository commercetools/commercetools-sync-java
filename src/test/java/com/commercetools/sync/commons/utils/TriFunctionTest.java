...
class TriFunctionTest {
    ...
    void apply_WithUpdateActionLocaleFilter_ShouldReturnCorrectResult() {
        ...
        List<UpdateAction<Product>> updateActions = Arrays.asList(ChangeName.of(newNameWithSameEnglishLocale),
            SetSku.of(1, "sku"));
        ...
        final List<UpdateAction<Product>> filteredActions = updateActionFilter
            .apply(updateActions, newDraftWithEnglishNameChange, oldProduct);
