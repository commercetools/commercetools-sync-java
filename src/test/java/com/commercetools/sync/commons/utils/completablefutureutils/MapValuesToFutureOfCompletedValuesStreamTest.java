...
class MapValuesToFutureOfCompletedValuesStreamTest {
  /** List to stream : empty values. Set to stream : empty values. */
  @Test
  void empty_ListToStream_ReturnsFutureOfEmptyStream() {
    final CompletableFuture<Stream<String>> future =
  ...
  /** List to Stream : single null value. Set to Stream : single null value. */
  @Test
  ...
  /**
   * * List to Stream : Same Type Mapping : Single Value. * Set to Stream : Same Type Mapping :
   * Single Value. * List to Stream : Diff Type Mapping : Single Value. * Set to Stream : Diff Type
  ...
  void single_ListWithDiffTypeMapping_ReturnsFutureOfStreamOfMappedValue() {
    final CompletableFuture<Stream<Integer>> future =
        mapValuesToFutureOfCompletedValues(
  ...
  /**
   * * List to Stream : Same Type Mapping : Multiple Values : no duplicates. * Set to Stream : Same
   * Type Mapping : Multiple Values : no duplicates. * List to Stream : Diff Type Mapping : Multiple
   * Values : no duplicates. * Set to Stream : Diff Type Mapping : Multiple Values : no duplicates.
   */
  @Test
  ...
  void multiple_SetWithSameTypeMappingNoDuplicates_ReturnsFutureOfStreamOfMappedValues() {
    ...
    final CompletableFuture<Stream<String>> future =
        mapValuesToFutureOfCompletedValues(
            set, element -> completedFuture(element.concat("POSTFIX")));
    final Stream<String> result = future.join();
  ...
  void multiple_SetWithDiffTypeMappingNoDuplicates_ReturnsFutureOfStreamOfMappedValues() {
    ...
    final CompletableFuture<Stream<Integer>> future =
        mapValuesToFutureOfCompletedValues(set, element -> completedFuture(element.length()));
    final Stream<Integer> result = future.join();
    assertThat(result).containsExactlyInAnyOrder(4, 5);
  }

  /**
   * * List to Stream : Same Type Mapping : Multiple Values : duplicates. * Set to Stream : Same
   * Type Mapping : Multiple Values : duplicates. * List to Stream : Diff Type Mapping : Multiple
   * Values : duplicates. * Set to Stream : Diff Type Mapping : Multiple Values : duplicates.
   */
  @Test
  void
      multiple_ListWithSameTypeMappingDuplicates_ReturnsFutureOfStreamOfMappedValuesWithDuplicates() {
    final CompletableFuture<Stream<String>> future =
        mapValuesToFutureOfCompletedValues(
  ...
  @Test
  void
      multiple_SetWithSameTypeMappingDuplicates_ReturnsFutureOfStreamOfMappedValuesWithDuplicates() {
    final Set<String> set = new HashSet<>();
    set.add("foo");
    set.add("bar");

    final CompletableFuture<Stream<String>> future =
        mapValuesToFutureOfCompletedValues(set, element -> completedFuture("constantResult"));
    final Stream<String> result = future.join();
  ...
  @Test
  void
      multiple_ListWithDiffTypeMappingDuplicates_ReturnsFutureOfStreamOfMappedValuesWithDuplicates() {
    final CompletableFuture<Stream<Integer>> future =
        mapValuesToFutureOfCompletedValues(
  ...
  @Test
  void
      multiple_SetWithDiffTypeMappingDuplicates_ReturnsFutureOfStreamOfMappedValuesWithDuplicates() {
    final Set<String> set = new HashSet<>();
    set.add("foo");
    set.add("bar");
