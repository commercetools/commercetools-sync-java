...
class MapStreamValuesToFutureOfCompletedValuesTest {
  ...
  void empty_StreamToSet_ReturnsFutureOfEmptySet() {
    final CompletableFuture<Set<String>> future =
        mapValuesToFutureOfCompletedValues(
            Stream.<String>empty(), CompletableFuture::completedFuture, toSet());
  ...
  @Test
  void
      multiple_StreamToListWithSameTypeMappingDuplicates_ReturnsFutureOfListOfMappedValuesWithDuplicates() {
    final CompletableFuture<List<String>> future =
        mapValuesToFutureOfCompletedValues(
            Stream.of("foo", "foo"),
            element -> completedFuture(element.concat("POSTFIX")),
  ...
  @Test
  void
      multiple_StreamToSetWithSameTypeMappingDuplicates_ReturnsFutureOfSetOfMappedValuesNoDuplicates() {
    final CompletableFuture<Set<String>> future =
        mapValuesToFutureOfCompletedValues(
            Stream.of("foo", "foo"),
            element -> completedFuture(element.concat("POSTFIX")),
  ...
  @Test
  void
      multiple_StreamToListWithDiffTypeMappingDuplicates_ReturnsFutureOfListOfMappedValuesWithDuplicates() {
    final CompletableFuture<List<Integer>> future =
        mapValuesToFutureOfCompletedValues(
  ...
  @Test
  void
      multiple_StreamToSetWithDiffTypeMappingDuplicates_ReturnsFutureOfSetOfMappedValuesNoDuplicates() {
    final CompletableFuture<Set<Integer>> future =
        mapValuesToFutureOfCompletedValues(
