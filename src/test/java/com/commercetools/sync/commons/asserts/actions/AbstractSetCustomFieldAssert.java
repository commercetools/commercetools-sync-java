...
public class AbstractSetCustomFieldAssert<T extends AbstractSetCustomFieldAssert<T, S>, S extends SetCustomFieldBase>
    ...
    /**
     * Verifies that the actual {@link SetCustomFieldBase} value has identical fields as the ones supplied.
     *
