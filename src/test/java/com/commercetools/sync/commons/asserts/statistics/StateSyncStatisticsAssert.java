...
public final class StateSyncStatisticsAssert
  ...
  /**
   * Verifies that the actual {@link StateSyncStatistics} value has identical statistics counters as
   * the ones supplied.
   *
   ...
   */
  public StateSyncStatisticsAssert hasValues(
      final int processed,
      final int created,
      final int updated,
      final int failed,
    ...
    assertThat(actual.getNumberOfStatesWithMissingParents())
        .isEqualTo(numberOfStatesWithMissingParents);
    return myself;
  }
}
