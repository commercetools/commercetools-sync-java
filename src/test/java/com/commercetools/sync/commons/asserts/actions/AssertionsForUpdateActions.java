...
public final class AssertionsForUpdateActions {
     ...
     */
    @Nonnull
    public static AbstractSetCustomFieldAssert assertThat(@Nullable final SetCustomFieldBase updateAction) {
        return new SetCustomFieldAssert(updateAction);
    }

    /**
     * Create assertion for {@link io.sphere.sdk.categories.commands.updateactions.SetAssetCustomType}.
     *
     * @param updateAction the actual value.
     * @return the created assertion object.
     */
    ...
    public static CategorySetAssetCustomTypeAssert assertThat(
        @Nullable final io.sphere.sdk.categories.commands.updateactions.SetAssetCustomType updateAction) {
        return new CategorySetAssetCustomTypeAssert(updateAction);
    }

    /**
     * Create assertion for {@link io.sphere.sdk.categories.commands.updateactions.SetAssetCustomField}.
     *
     * @param updateAction the actual value.
     * @return the created assertion object.
     */
    ...
    public static CategorySetAssetCustomFieldAssert assertThat(
        @Nullable final io.sphere.sdk.categories.commands.updateactions.SetAssetCustomField updateAction) {
    ...
    public static ProductSetAssetCustomTypeAssert assertThat(
        @Nullable final io.sphere.sdk.products.commands.updateactions.SetAssetCustomType updateAction) {
    ...
    public static ProductSetAssetCustomFieldAssert assertThat(
        @Nullable final io.sphere.sdk.products.commands.updateactions.SetAssetCustomField updateAction) {
     ...
     */
    @Nonnull
    public static SetPriceCustomTypeAssert assertThat(@Nullable final SetProductPriceCustomType updateAction) {
     ...
     */
    @Nonnull
    public static SetPriceCustomFieldAssert assertThat(@Nullable final SetProductPriceCustomField updateAction) {
