...
public final class ProductTypeSyncStatisticsAssert
    extends AbstractSyncStatisticsAssert<
        ProductTypeSyncStatisticsAssert, ProductTypeSyncStatistics> {
  ...
  /**
   * Verifies that the actual {@link ProductTypeSyncStatistics} value has identical statistics
   * counters as the ones supplied.
   *
   ...
   * @param numberOfProductTypesWithMissingNestedReferences the number of productTypes with missing
   *     nestedType references.
   * @return {@code this} assertion object.
   * @throws AssertionError if the actual value is {@code null}.
   * @throws AssertionError if the actual statistics do not match the supplied values.
   */
  public ProductTypeSyncStatisticsAssert hasValues(
      final int processed,
      final int created,
      final int updated,
      final int failed,
