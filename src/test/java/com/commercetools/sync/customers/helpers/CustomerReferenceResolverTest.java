...
class CustomerReferenceResolverTest {
    ...
    void resolveReferences_WithoutReferences_ShouldNotResolveReferences() {
        ...
        final CustomerDraft resolvedDraft = referenceResolver
    ...
    void resolveCustomTypeReference_WithNullKeyOnCustomTypeReference_ShouldNotResolveCustomTypeReference() {
        ...
        assertThat(referenceResolver.resolveCustomTypeReference(customerDraftBuilder).toCompletableFuture())
            ...
            .hasMessage(format("Failed to resolve custom type reference on CustomerDraft with "
                + "key:'customer-key'. Reason: %s", BLANK_KEY_VALUE_ON_RESOURCE_IDENTIFIER));
    }
    ...
    void resolveReferences_WithAllValidReferences_ShouldResolveReferences() {
        ...
        final CustomerDraft expectedDraft = CustomerDraftBuilder
            .of(customerDraft)
    ...
    void resolveCustomerGroupReference_WithKeys_ShouldResolveReference() {
        ...
        final CustomerDraftBuilder resolvedDraft = referenceResolver.resolveCustomerGroupReference(customerDraftBuilder)
    ...
    @Test
    void resolveCustomerGroupReference_WithNullKeyOnCustomerGroupReference_ShouldNotResolveReference() {
        final CustomerDraftBuilder customerDraftBuilder = CustomerDraftBuilder
            .of("email@example.com", "secret123")
    ...
    @Test
    void resolveCustomerGroupReference_WithEmptyKeyOnCustomerGroupReference_ShouldNotResolveReference() {
        final CustomerDraftBuilder customerDraftBuilder = CustomerDraftBuilder
            .of("email@example.com", "secret123")
    ...
    void resolveCustomerGroupReference_WithIdOnCustomerGroupReference_ShouldNotResolveReference() {
        ...
        assertThat(referenceResolver.resolveCustomerGroupReference(customerDraftBuilder).toCompletableFuture())
            .hasNotFailed()
            .isCompletedWithValueMatching(resolvedDraft -> Objects.equals(resolvedDraft.getCustomerGroup(),
                customerDraftBuilder.getCustomerGroup()));
    }
    ...
    void resolveStoreReferences_WithNullKeyOnStoreReference_ShouldNotResolveReference() {
        ...
        assertThat(referenceResolver.resolveStoreReferences(customerDraftBuilder))
            .hasFailedWithThrowableThat()
            .isExactlyInstanceOf(ReferenceResolutionException.class)
            .hasMessage(format(FAILED_TO_RESOLVE_STORE_REFERENCE, "dummyKey", BLANK_KEY_VALUE_ON_RESOURCE_IDENTIFIER));
    }
