...
class PriceReferenceResolverTest {
    ...
    @Test
    void resolveChannelReference_WithNonExistingChannelAndNotEnsureChannel_ShouldNotResolveChannelReference() {
        // Preparation
    ...
    @Test
    void resolveChannelReference_WithNonExistingChannelAndEnsureChannel_ShouldResolveSupplyChannelReference() {
        // Preparation
