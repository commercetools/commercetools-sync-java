...
class InventorySyncUtilsTest {
  ...
  void setup() {
    ...
    inventoryEntryWithCustomField1 =
        getMockInventoryEntry("123", 10L, 10, DATE_1, reference, customFields);

    similarDraft =
        InventoryEntryDraftBuilder.of("123", 10L, DATE_1, 10, ResourceIdentifier.ofId("111"))
            .build();
    variousDraft =
        InventoryEntryDraftBuilder.of("321", 20L, DATE_2, 20, ResourceIdentifier.ofId("222"))
            .build();
  }

  @Test
  void buildActions_WithSimilarEntries_ShouldReturnEmptyList() {
    List<UpdateAction<InventoryEntry>> actions =
  ...
  void buildActions_WithSimilarEntriesAndSameCustomFields_ShouldReturnEmptyList() {
    final InventoryEntryDraft draft =
        InventoryEntryDraftBuilder.of(similarDraft)
