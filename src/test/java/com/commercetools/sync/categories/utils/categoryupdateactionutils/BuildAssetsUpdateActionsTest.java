...
class BuildAssetsUpdateActionsTest {
  ...
  void buildAssetsUpdateActions_WithNullNewAssetsAndExistingAssets_ShouldBuild3RemoveActions() {
    ...
    final List<UpdateAction<Category>> updateActions =
        buildAssetsUpdateActions(
            oldCategory,
            CategoryDraftBuilder.of(ofEnglish("name"), ofEnglish("slug")).assets(null).build(),
            syncOptions);

    assertThat(updateActions)
        .containsExactlyInAnyOrder(
            RemoveAsset.ofKey("a"), RemoveAsset.ofKey("b"), RemoveAsset.ofKey("c"));
  }
  ...
  void
    ...
    assertThat(warningCallBackMessages.get(0))
        .isEqualTo(format(ASSET_KEY_NOT_SET, "name: LocalizedString(en -> asset name)"));
  }
  ...
  void
    ...
    assertThat(updateActions)
        .containsExactly(RemoveAsset.ofKey("a"), ChangeAssetOrder.of(asList("3", "2")));
  }
