...
class BuildAssetsUpdateActionsTest {
  ...
  void buildAssetsUpdateActions_WithNullNewAssetsAndExistingAssets_ShouldBuild3RemoveActions() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);

    final List<CategoryUpdateAction> updateActions =
        CategoryUpdateActionUtils.buildAssetsUpdateActions(
            oldCategory,
  ...
  void buildAssetsUpdateActions_WithNewAssetsAndNoOldAssets_ShouldBuild3AddActions() {
    ...
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, CategoryDraft.class);

    final List<CategoryUpdateAction> updateActions =
        CategoryUpdateActionUtils.buildAssetsUpdateActions(
            oldCategory, newCategoryDraft, syncOptions);
  ...
  void
    ...
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(
            CATEGORY_DRAFT_WITH_ASSETS_WITHOUT_KEY, CategoryDraft.class);
    ...
    assertThat(warningCallBackMessages.get(0))
        .isEqualTo(
            String.format(AssetsUpdateActionUtils.ASSET_KEY_NOT_SET, "name: {en=asset name}"));
  }
  ...
  void
    ...
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_WITHOUT_KEY, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, CategoryDraft.class);
    ...
    assertThat(updateActions)
        .containsExactlyInAnyOrder(
            CategoryAddAssetActionBuilder.of()
                ...
                .build());
    assertThat(warningCallBackMessages.get(0))
        .isEqualTo(String.format(AssetsUpdateActionUtils.ASSET_KEY_NOT_SET, "id: 3"));
  }
  ...
  void buildAssetsUpdateActions_WithDuplicateAssetKeys_ShouldNotBuildActionsAndTriggerErrorCb() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABB, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithSameAssetPositionButChangesWithin_ShouldBuildUpdateActions() {
    ...
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(
            CATEGORY_DRAFT_WITH_ASSETS_ABC_WITH_CHANGES, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithOneMissingAsset_ShouldBuildRemoveAssetAction() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_AB, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithOneExtraAsset_ShouldBuildAddAssetAction() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABCD, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithOneAssetSwitch_ShouldBuildRemoveAndAddAssetActions() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABD, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithDifferent_ShouldBuildChangeAssetOrderAction() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_CAB, CategoryDraft.class);
  ...
  void
    ...
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_CB, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithAddedAndDifferentOrder_ShouldBuildChangeOrderAndAddActions() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ACBD, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithAddedAssetInBetween_ShouldBuildAddWithCorrectPositionActions() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ADBC, CategoryDraft.class);
  ...
  void buildAssetsUpdateActions_WithAddedRemovedAndDifOrder_ShouldBuildAllThreeMoveAssetActions() {
    final Category oldCategory =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_ABC, Category.class);
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(CATEGORY_DRAFT_WITH_ASSETS_CBD, CategoryDraft.class);
  ...
  void
    ...
    final CategoryDraft newCategoryDraft =
        TestUtils.readObjectFromResource(
            CATEGORY_DRAFT_WITH_ASSETS_CBD_WITH_CHANGES, CategoryDraft.class);
