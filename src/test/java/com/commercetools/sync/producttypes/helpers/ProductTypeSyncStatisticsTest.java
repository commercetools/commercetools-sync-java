...
class ProductTypeSyncStatisticsTest {
    ...
    void getReportMessage_WithIncrementedStats_ShouldGetCorrectMessage() {
        // preparation
        final ProductTypeSyncStatistics productTypeSyncStatistics = mock(ProductTypeSyncStatistics.class);
        ...
        when(productTypeSyncStatistics.getNumberOfProductTypesWithMissingNestedProductTypes()).thenReturn(0);
    ...
    @Test
    void getNumberOfProductTypesWithMissingNestedProductTypes_WithMissingButNoReferencingProductType_ShouldBe0() {
        // preparation
        final ConcurrentHashMap<String,
            ConcurrentHashMap<String, ConcurrentHashMap.KeySetView<AttributeDefinitionDraft, Boolean>>>
            missingProductTypeReferences = new ConcurrentHashMap<>();
    ...
    @Test
    void putMissingNestedProductType_WithExistingReferencingPTypeToAnotherMissingRef_ShouldAppendAttribute() {
        // preparation
        final ConcurrentHashMap<String,
            ConcurrentHashMap<String, ConcurrentHashMap.KeySetView<AttributeDefinitionDraft, Boolean>>>
            missingProductTypeReferences = new ConcurrentHashMap<>();
        ...
        // test
        productTypeSyncStatistics.putMissingNestedProductType("missing3",
            "referencing-product-type-1",
            referencingAttributeDefinitionDraft);

        // assertion
        assertThat(productTypeSyncStatistics.getProductTypeKeysWithMissingParents()).hasSize(3);
        assertThat(productTypeSyncStatistics.getProductTypeKeysWithMissingParents().get("missing3")).hasSize(1);
        assertThat(productTypeSyncStatistics.getProductTypeKeysWithMissingParents()
                                            .get("missing3")
                                            .get("referencing-product-type-1"))
