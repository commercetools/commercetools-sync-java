...
import static com.commercetools.sync.sdk2.inventories.InventorySyncMockUtils.*;
...
class InventorySyncTest {
  ...
  void setup() {
    ...
    drafts =
        List.of(
            createInventoryDraftBuilderWithoutChannel(SKU_1, QUANTITY_1, DATE_1, RESTOCKABLE_1)
                .build(),
            createInventoryDraftBuilderWithoutChannel(SKU_1, QUANTITY_1, DATE_1, RESTOCKABLE_1)
                .supplyChannel(resourceIdentifierBuilder -> resourceIdentifierBuilder.key(KEY_2))
                .build(),
            createInventoryDraftBuilderWithoutChannel(SKU_2, QUANTITY_2, DATE_2, RESTOCKABLE_2)
                .build(),
            createInventoryDraftBuilderWithoutChannel(SKU_2, QUANTITY_2, DATE_2, RESTOCKABLE_2)
            ...
            createInventoryDraftBuilderWithoutChannel(SKU_2, QUANTITY_2, DATE_2, RESTOCKABLE_2)
                .supplyChannel(resourceIdentifierBuilder -> resourceIdentifierBuilder.key(KEY_2))
                .build(),
            createInventoryDraftBuilderWithoutChannel(SKU_3, QUANTITY_1, DATE_1, RESTOCKABLE_1)
                .build(),
            createInventoryDraftBuilderWithoutChannel(SKU_3, QUANTITY_1, DATE_1, RESTOCKABLE_1)
                .supplyChannel(resourceIdentifierBuilder -> resourceIdentifierBuilder.key(KEY_2))
                .build());
  ...
  void sync_WithExceptionWhenUpdatingEntries_ShouldNotSync() {
    ...
    final InventoryEntryDraft inventoryEntryDraft =
        createInventoryDraftBuilderWithoutChannel(SKU_2, QUANTITY_2, DATE_1, RESTOCKABLE_1)
            .supplyChannel(
