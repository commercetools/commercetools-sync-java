...
public final class PlainEnumValueFixtures {
  ...
  public static final class AttributePlainEnumValueFixtures {
  ...
  public static final class CustomFieldEnumValueFixtures {

    public static final CustomFieldEnumValue ENUM_VALUE_A =
        CustomFieldEnumValueBuilder.of().key("a").label("label_a").build();
    public static final CustomFieldEnumValue ENUM_VALUE_A_DIFFERENT_LABEL =
        CustomFieldEnumValueBuilder.of().key("a").label("label_a_diff").build();
    public static final CustomFieldEnumValue ENUM_VALUE_B =
        CustomFieldEnumValueBuilder.of().key("b").label("label_b").build();
    public static final CustomFieldEnumValue ENUM_VALUE_C =
        CustomFieldEnumValueBuilder.of().key("c").label("label_c").build();
    public static final CustomFieldEnumValue ENUM_VALUE_D =
        CustomFieldEnumValueBuilder.of().key("d").label("label_d").build();

    public static final List<CustomFieldEnumValue> ENUM_VALUES_ABC =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_C));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_AB =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_BAC =
        unmodifiableList(asList(ENUM_VALUE_B, ENUM_VALUE_A, ENUM_VALUE_C));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_AB_WITH_DIFFERENT_LABEL =
        unmodifiableList(asList(ENUM_VALUE_A_DIFFERENT_LABEL, ENUM_VALUE_B));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_ABB =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_B));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_ABD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_D));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_ABCD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_C, ENUM_VALUE_D));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_CAB =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_A, ENUM_VALUE_B));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_CB =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_B));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_ACBD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_C, ENUM_VALUE_B, ENUM_VALUE_D));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_ADBC =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_D, ENUM_VALUE_B, ENUM_VALUE_C));
    public static final List<CustomFieldEnumValue> ENUM_VALUES_CBD =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_B, ENUM_VALUE_D));
  }
