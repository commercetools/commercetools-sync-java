...
public final class LocalizedEnumValueFixtures {
  ...
  public static final class AttributeLocalizedEnumValueFixtures {
  ...
  public static final class CustomFieldLocalizedEnumValueFixtures {

    public static final CustomFieldLocalizedEnumValue ENUM_VALUE_A =
        CustomFieldLocalizedEnumValueBuilder.of().key("a").label(ofEnglish("label_a")).build();
    public static final CustomFieldLocalizedEnumValue ENUM_VALUE_A_DIFFERENT_LABEL =
        CustomFieldLocalizedEnumValueBuilder.of().key("a").label(ofEnglish("label_a_diff")).build();
    public static final CustomFieldLocalizedEnumValue ENUM_VALUE_B =
        CustomFieldLocalizedEnumValueBuilder.of().key("b").label(ofEnglish("label_b")).build();
    public static final CustomFieldLocalizedEnumValue ENUM_VALUE_C =
        CustomFieldLocalizedEnumValueBuilder.of().key("c").label(ofEnglish("label_c")).build();
    public static final CustomFieldLocalizedEnumValue ENUM_VALUE_D =
        CustomFieldLocalizedEnumValueBuilder.of().key("d").label(ofEnglish("label_d")).build();

    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ABC =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_C));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_BAC =
        unmodifiableList(asList(ENUM_VALUE_B, ENUM_VALUE_A, ENUM_VALUE_C));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_AB_WITH_DIFFERENT_LABEL =
        unmodifiableList(asList(ENUM_VALUE_A_DIFFERENT_LABEL, ENUM_VALUE_B));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_AB =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ABB =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_B));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ABD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_D));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ABCD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_B, ENUM_VALUE_C, ENUM_VALUE_D));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_CAB =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_A, ENUM_VALUE_B));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_CB =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_B));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ACBD =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_C, ENUM_VALUE_B, ENUM_VALUE_D));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_ADBC =
        unmodifiableList(asList(ENUM_VALUE_A, ENUM_VALUE_D, ENUM_VALUE_B, ENUM_VALUE_C));
    public static final List<CustomFieldLocalizedEnumValue> ENUM_VALUES_CBD =
        unmodifiableList(asList(ENUM_VALUE_C, ENUM_VALUE_B, ENUM_VALUE_D));
  }
