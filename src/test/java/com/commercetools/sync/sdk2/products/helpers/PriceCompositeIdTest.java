...
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.prices.PriceDraftFixtures.*;
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.prices.PriceFixtures.*;
...
class PriceCompositeIdTest {
  ...
  private static final String CASE_16 =
      "with currency, countryCode, channel, customerGroup and validFrom";
  ...
  private static final String CASE_24 =
      "with currency, countryCode, channel, customerGroup and validUntil";
  ...
  private static final String CASE_28 =
      "with currency, countryCode, channel, validFrom and validUntil";
  private static final String CASE_29 = "with currency, customerGroup, validFrom and validUntil";
  private static final String CASE_30 =
      "with currency, countryCode, customerGroup, validFrom and validUntil";
  private static final String CASE_31 =
      "with currency, channel, customerGroup, validFrom and validUntil";
  ...
  void ofPriceDraft_ShouldCreateCompositeId(
  ...
  private static Stream<Arguments> ofPriceDraftTestCases() {
    return Stream.of(
        ...
        Arguments.of(CASE_2, DRAFT_US_111_USD, "USD", "United States", null, null, null, null),
        Arguments.of(CASE_3, DRAFT_111_USD_CHANNEL1, "USD", null, null, "channel1", null, null),
        Arguments.of(
            CASE_4,
            DRAFT_US_111_USD_CHANNEL1,
            "USD",
            "United States",
            null,
            "channel1",
        ...
        Arguments.of(CASE_6, DRAFT_DE_333_USD_CUST1, "USD", "Germany", "cust1", null, null, null),
        Arguments.of(
            CASE_7, DRAFT_111_USD_CHANNEL1_CUST1, "USD", null, "cust1", "channel1", null, null),
        Arguments.of(
            CASE_8,
            DRAFT_US_111_USD_CHANNEL1_CUST1,
            "USD",
            "United States",
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_11,
            DRAFT_111_USD_CHANNEL1_FROM_01,
            "USD",
            null,
            null,
            "channel1",
        ...
        Arguments.of(
            CASE_12,
            DRAFT_US_111_USD_CHANNEL1_FROM_01,
            "USD",
            "United States",
            null,
            "channel1",
            ...
            null),
        Arguments.of(
            CASE_13, DRAFT_111_USD_CUST1_FROM_01, "USD", null, "cust1", null, byMonth(1), null),
        Arguments.of(
            CASE_14,
            DRAFT_US_111_USD_CUST1_FROM_01,
            "USD",
            "United States",
            "cust1",
            null,
        ...
        Arguments.of(
            CASE_15,
            DRAFT_111_USD_CHANNEL1_CUST1_FROM_01,
            "USD",
            null,
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_16,
            DRAFT_US_111_USD_CHANNEL1_CUST1_FROM_01,
            "USD",
            "United States",
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_19,
            DRAFT_111_USD_CHANNEL1_UNTIL_01,
            "USD",
            null,
            null,
            "channel1",
        ...
        Arguments.of(
            CASE_20,
            DRAFT_US_111_USD_CHANNEL1_UNTIL_01,
            "USD",
            "United States",
            null,
            "channel1",
            ...
            byMonth(1)),
        Arguments.of(
            CASE_21, DRAFT_111_USD_CUST1_UNTIL_01, "USD", null, "cust1", null, null, byMonth(1)),
        Arguments.of(
            CASE_22,
            DRAFT_US_111_USD_CUST1_UNTIL_01,
            "USD",
            "United States",
            "cust1",
            null,
        ...
        Arguments.of(
            CASE_23,
            DRAFT_111_USD_CHANNEL1_CUST1_UNTIL_01,
            "USD",
            null,
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_24,
            DRAFT_US_111_USD_CHANNEL1_CUST1_UNTIL_01,
            "USD",
            "United States",
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_26, DRAFT_DE_111_EUR_01_02, "EUR", "Germany", null, null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_27,
            DRAFT_111_EUR_CHANNEL1_01_02,
            "EUR",
            null,
            null,
            "channel1",
        ...
        Arguments.of(
            ...
            byMonth(2)),
        Arguments.of(
            CASE_29, DRAFT_666_USD_CUST1_01_02, "USD", null, "cust1", null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_30,
        ...
        Arguments.of(
            CASE_31,
            DRAFT_777_CUST1_CHANNEL1_EUR_05_07,
            "EUR",
            null,
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_32,
            DRAFT_NE_777_CUST1_CHANNEL1_EUR_05_07,
            "EUR",
            "Niger",
            "cust1",
            "channel1",
  ...
  void ofPrice_ShouldCreateCompositeId(
      @Nonnull final String testCaseName,
  ...
  private static Stream<Arguments> ofPriceTestCases() {
    return Stream.of(
        ...
        Arguments.of(CASE_2, US_111_USD, "USD", "United States", null, null, null, null),
        Arguments.of(CASE_3, EUR_345_CHANNEL1, "EUR", null, null, "channel1", null, null),
        Arguments.of(CASE_4, DE_345_EUR_CHANNEL1, "EUR", "Germany", null, "channel1", null, null),
        Arguments.of(CASE_5, EUR_345_CUST2, "EUR", null, "cust2", null, null, null),
        Arguments.of(CASE_6, DE_345_EUR_CUST2, "EUR", "Germany", "cust2", null, null, null),
        Arguments.of(CASE_7, EUR_345_CHANNEL1_CUST1, "EUR", null, "cust1", "channel1", null, null),
        Arguments.of(
            CASE_8, DE_345_EUR_CHANNEL1_CUST1, "EUR", "Germany", "cust1", "channel1", null, null),
        Arguments.of(CASE_9, USD_111_FROM_01, "USD", null, null, null, byMonth(1), null),
        Arguments.of(
            CASE_10, US_111_USD_FROM_01, "USD", "United States", null, null, byMonth(1), null),
        Arguments.of(
            CASE_11, USD_111_CHANNEL1_FROM_01, "USD", null, null, "channel1", byMonth(1), null),
        Arguments.of(
            CASE_12,
            US_111_USD_CHANNEL1_FROM_01,
            "USD",
            "United States",
            null,
            "channel1",
        ...
        Arguments.of(
            CASE_15,
            USD_111_CHANNEL1_CUST1_FROM_01,
            "USD",
            null,
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_16,
            US_111_USD_CHANNEL1_CUST1_FROM_01,
            "USD",
            "United States",
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_18, US_111_USD_UNTIL_01, "USD", "United States", null, null, null, byMonth(1)),
        Arguments.of(
            CASE_19, USD_111_CHANNEL1_UNTIL_01, "USD", null, null, "channel1", null, byMonth(1)),
        Arguments.of(
            CASE_20,
            US_111_USD_CHANNEL1_UNTIL_01,
            "USD",
            "United States",
            null,
            "channel1",
        ...
        Arguments.of(
            CASE_23,
            USD_111_CHANNEL1_CUST1_UNTIL_01,
            "USD",
            null,
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_24,
            US_111_USD_CHANNEL1_CUST1_UNTIL_01,
            "USD",
            "United States",
            "cust1",
            "channel1",
        ...
        Arguments.of(
            CASE_26, US_111_USD_01_02, "USD", "United States", null, null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_27, USD_111_CHANNEL1_01_02, "USD", null, null, "channel1", byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_28,
            ...
            byMonth(2)),
        Arguments.of(
            CASE_29, USD_111_CUST1_01_02, "USD", null, "cust1", null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_30,
            US_111_USD_CUST1_01_02,
            "USD",
            "United States",
            "cust1",
            null,
        ...
        Arguments.of(
            CASE_32,
            US_555_USD_CUST2_CHANNEL1_01_02,
            "USD",
            "United States",
            "cust2",
            "channel1",
  ...
  private static void assertCompositeId(
      @Nonnull final String currencyCode,
      @Nullable final String countryCode,
      @Nullable final String customerGroupId,
      @Nullable final String channelId,
  ...
  private static Stream<Arguments> equalsTestCases() {
    ...
    return Stream.of(
        ...
        Arguments.of(
            "Equal but different instances", priceCompositeId, PriceCompositeId.of(USD_111), true),
        Arguments.of(
            "Not equal countryCode", priceCompositeId, PriceCompositeId.of(DE_111_EUR), false),
        Arguments.of(
            "Not equal currencyCode",
            priceCompositeId,
            PriceCompositeId.of(EUR_345_CHANNEL1),
            false),
        Arguments.of(
            "Not equal channelId",
            priceCompositeId,
            PriceCompositeId.of(USD_111_CHANNEL1_01_02),
            false),
        Arguments.of(
            "Not equal customerGroupId",
            priceCompositeId,
            PriceCompositeId.of(USD_111_CUST1_01_02),
            false),
        Arguments.of(
            "Not equal validFrom", priceCompositeId, PriceCompositeId.of(USD_111_FROM_01), false),
        Arguments.of(
            "Not equal validUntil",
            priceCompositeId,
            PriceCompositeId.of(USD_111_UNTIL_01),
            false));
  }
}
