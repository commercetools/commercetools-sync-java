...
class PriceCompositeIdTest {
  ...
  private static Stream<Arguments> ofPriceDraftTestCases() {
    return Stream.of(
        ...
        Arguments.of(
            CASE_8, DRAFT_US_111_USD_CHANNEL1_CUST1, "USD", "US", "cust1", "channel1", null, null),
        ...
        Arguments.of(
            CASE_14, DRAFT_US_111_USD_CUST1_FROM_01, "USD", "US", "cust1", null, byMonth(1), null),
        Arguments.of(
            CASE_15,
        ...
        Arguments.of(
            CASE_22, DRAFT_US_111_USD_CUST1_UNTIL_01, "USD", "US", "cust1", null, null, byMonth(1)),
        Arguments.of(
            CASE_23,
        ...
        Arguments.of(
            CASE_26, DRAFT_DE_111_EUR_01_02, "EUR", "DE", null, null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_27,
  ...
  private static Stream<Arguments> ofPriceTestCases() {
    return Stream.of(
        ...
        Arguments.of(
            CASE_8, DE_345_EUR_CHANNEL1_CUST1, "EUR", "DE", "cust1", "channel1", null, null),
        ...
        Arguments.of(
            CASE_12, US_111_USD_CHANNEL1_FROM_01, "USD", "US", null, "channel1", byMonth(1), null),
        Arguments.of(CASE_13, USD_111_CUST1_FROM_01, "USD", null, "cust1", null, byMonth(1), null),
        Arguments.of(
            CASE_14, US_111_USD_CUST1_FROM_01, "USD", "US", "cust1", null, byMonth(1), null),
        Arguments.of(
            CASE_15,
        ...
        Arguments.of(
            CASE_20, US_111_USD_CHANNEL1_UNTIL_01, "USD", "US", null, "channel1", null, byMonth(1)),
        Arguments.of(CASE_21, USD_111_CUST1_UNTIL_01, "USD", null, "cust1", null, null, byMonth(1)),
        Arguments.of(
            CASE_22, US_111_USD_CUST1_UNTIL_01, "USD", "US", "cust1", null, null, byMonth(1)),
        Arguments.of(
            CASE_23,
        ...
        Arguments.of(
            CASE_30, US_111_USD_CUST1_01_02, "USD", "US", "cust1", null, byMonth(1), byMonth(2)),
        Arguments.of(
            CASE_31,
