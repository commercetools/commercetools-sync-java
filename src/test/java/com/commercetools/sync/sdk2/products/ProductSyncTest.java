...
class ProductSyncTest {
  ...
  void sync_WithNoValidDrafts_ShouldCompleteWithoutAnyProcessing() {
    ...
    final com.commercetools.sync.products.ProductSyncOptions productSyncOptions = ProductSyncOptionsBuilder.of(ctpClient).build();
  ...
  void sync_WithErrorCachingKeys_ShouldExecuteCallbackOnErrorAndIncreaseFailedCounter() {
    ...
    final com.commercetools.sync.products.ProductSyncOptions syncOptions =
  ...
  void sync_WithOnlyDraftsToCreate_ShouldCallBeforeCreateCallback() {
    ...
    final com.commercetools.sync.products.ProductSyncOptions spyProductSyncOptions = spy(productSyncOptions);
