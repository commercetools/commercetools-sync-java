...
class ProductVariantPriceUpdateActionUtilsTest {
    ...
    //  private static final TypedMoney EUR_10 = Money.builder().centAmount(BigDecimal.valueOf(1000).longValue()).currencyCode("EUR").build();
    private static final TypedMoney EUR_10 = TypedMoneyBuilder.of().centPrecisionBuilder().centAmount(BigDecimal.valueOf(1000).longValue()).currencyCode("EUR").build();
    private static final TypedMoney EUR_20 = TypedMoneyBuilder.of().centPrecisionBuilder().centAmount(BigDecimal.valueOf(2000).longValue()).currencyCode("EUR").build();
    private static final PriceTier TIER_1_EUR_10 = PriceTierBuilder.of().value(EUR_10).minimumQuantity(1L).build();
    private static final PriceTierDraft TIER_1_EUR_10_DRAFT = PriceTierDraftBuilder.of().value(EUR_10).minimumQuantity(1L).build();
    private static final PriceTier TIER_2_EUR_10 = PriceTierBuilder.of().value(EUR_10).minimumQuantity(2L).build();
    private static final PriceTierDraft TIER_2_EUR_10_DRAFT = PriceTierDraftBuilder.of().value(EUR_10).minimumQuantity(2L).build();
    private static final PriceTier TIER_1_EUR_20 = PriceTierBuilder.of().value(EUR_20).minimumQuantity(1L).build();
    private static final PriceTierDraft TIER_1_EUR_20_DRAFT = PriceTierDraftBuilder.of().value(EUR_20).minimumQuantity(1L).build();

    private static final Price PRICE_EUR_10_TIER_1_EUR_10 =
            PriceBuilder.of().value(EUR_10)
    ...
    private static final PriceDraft DRAFT_EUR_10_MULTIPLE_TIERS =
            PriceDraftBuilder.of().value(EUR_10).tiers(asList(TIER_2_EUR_10_DRAFT, TIER_1_EUR_10_DRAFT)).build();
    ...
    private static final Price PRICE_EUR_10_NULL_TIERS =
            PriceBuilder.of().value(EUR_10).id(UUID.randomUUID().toString()).tiers((PriceTier) null).build();
    ...
    private static Stream<Arguments> buildActionsTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        singletonList(
                                ProductChangePriceAction.builder().priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).price(DRAFT_EUR_20_TIER_1_EUR_10).staged(true).build()),
                        emptyList()),
                Arguments.of(
                        case5,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        ...
                        singletonList(
                                ProductChangePriceAction.builder().price(DRAFT_EUR_10_TIER_1_EUR_20).priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).staged(true).build()),
                        emptyList()),
                Arguments.of(
                        case6,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        ...
                        singletonList(
                                ProductChangePriceAction.builder().price(DRAFT_EUR_10_TIER_2_EUR_10).priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).staged(true).build()),
                        emptyList()),
                Arguments.of(
                        case7,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        ...
                        singletonList(
                                ProductChangePriceAction.builder().price(DRAFT_EUR_10_MULTIPLE_TIERS).priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).staged(true).build()),
                        emptyList()),
                Arguments.of(
                        case8,
                        ...
                        asList(
                                ProductChangePriceAction.builder().price(DRAFT_DE_100_EUR_01_02_CHANNEL1_CUSTOMTYPE1_CUSTOMFIELDX).priceId(DE_222_EUR_01_02_CHANNEL1_CUSTOMTYPE1_CUSTOMFIELDY.getId()).staged(true).build()),
                        ProductSetProductPriceCustomFieldAction.builder()
                                .name("foo")
                                .priceId(DE_222_EUR_01_02_CHANNEL1_CUSTOMTYPE1_CUSTOMFIELDY.getId())
                                .value(DRAFT_DE_100_EUR_01_02_CHANNEL1_CUSTOMTYPE1_CUSTOMFIELDX.getCustom().getFields())
                                .staged(true)
                                .build(),
                        emptyList()),
                Arguments.of(
    ...
    private static Stream<Arguments> buildChangePriceTestCases() {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        case4,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        DRAFT_EUR_20_TIER_1_EUR_10, ProductChangePriceAction.builder().priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).price(DRAFT_EUR_20_TIER_1_EUR_10).staged(true).build(),
                        emptyList()),
                Arguments.of(
                        case5,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        DRAFT_EUR_10_TIER_1_EUR_20,
                        ProductChangePriceAction.builder().priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).price(DRAFT_EUR_10_TIER_1_EUR_20).staged(true).build(),
                ...
                Arguments.of(
                        ...
                        PRICE_EUR_10_TIER_1_EUR_10,
                        DRAFT_EUR_10_TIER_2_EUR_10,
                        ProductChangePriceAction.builder().priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).price(DRAFT_EUR_10_TIER_2_EUR_10).staged(true).build(),
                        emptyList()),
                Arguments.of(
                        case7,
                        PRICE_EUR_10_TIER_1_EUR_10,
                        DRAFT_EUR_10_MULTIPLE_TIERS,
                        ProductChangePriceAction.builder().priceId(PRICE_EUR_10_TIER_1_EUR_10.getId()).price(DRAFT_EUR_10_MULTIPLE_TIERS).staged(true).build(),
                        emptyList()),
                Arguments.of(
                        case8,
                        PRICE_EUR_10_TIER_1_EUR_10,
    ...
    void buildCustomUpdateActions_WithSameStagedValues_ShouldNotBuildUpdateAction() {
        ...
        final FieldContainer oldCustomFieldContainer = FieldContainerBuilder.of().values(oldCustomFieldsMap).build();
        ...
        final CustomFieldsDraft newCustomFieldsDraft =
                CustomFieldsDraftBuilder.of().type(TypeResourceIdentifierBuilder.of().id("1").build()).fields(oldCustomFieldContainer).build();
        ...
        final PriceDraft newPrice =
                PriceDraftBuilder.of().value(EUR_10)
    ...
    void buildCustomUpdateActions_WithDifferentStagedValues_ShouldBuildUpdateAction() {
        ...
        final FieldContainer oldCustomFieldContainer = FieldContainerBuilder.of().values(oldCustomFieldsMap).build();
        final FieldContainer newCustomFieldContainer = FieldContainerBuilder.of().values(newCustomFieldsMap).build();
        ...
        final CustomFieldsDraft newCustomFieldsDraft =
                CustomFieldsDraft.builder().type(TypeResourceIdentifierBuilder.of().id("1").build())
                        .fields(newCustomFieldContainer).build();
    ...
    void buildCustomUpdateActions_WithNullOldStagedValues_ShouldBuildUpdateAction() {
        ...
        final CustomFieldsDraft newCustomFieldsDraft =
                CustomFieldsDraftBuilder.of().type(TypeResourceIdentifierBuilder.of().id("1").build())
                        .fields(newCustomFieldContainer).build();
        ...
        assertThat(updateActions)
                .containsExactly(
                        ProductSetProductPriceCustomTypeAction.builder().type(TypeResourceIdentifierBuilder.of().id("1").build()).fields(newCustomFieldContainer).priceId(oldPrice.getId()).staged(true).build();
    }
    ...
    buildCustomUpdateActions_WithBadCustomFieldData_ShouldNotBuildUpdateActionAndTriggerErrorCallback() {
        ...
        final CustomFieldsDraft newCustomFieldsDraft =
                CustomFieldsDraftBuilder.of().type(TypeResourceIdentifierBuilder.of().id("").build()).fields(newCustomFieldContainer).build();
