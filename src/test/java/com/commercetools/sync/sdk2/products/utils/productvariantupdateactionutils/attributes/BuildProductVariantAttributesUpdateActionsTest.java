...
import static com.commercetools.sync.sdk2.products.utils.ProductVariantUpdateActionUtils.NULL_PRODUCT_VARIANT_ATTRIBUTE;
...
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.attributes.AttributeFixtures.BOOLEAN_ATTRIBUTE_FALSE;
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.attributes.AttributeFixtures.BOOLEAN_ATTRIBUTE_TRUE;
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.attributes.AttributeFixtures.TEXT_ATTRIBUTE_BAR;
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.attributes.AttributeFixtures.TEXT_ATTRIBUTE_FOO;
import static com.commercetools.sync.sdk2.products.utils.productvariantupdateactionutils.attributes.AttributeFixtures.TIME_ATTRIBUTE_10_08_46;
...
class BuildProductVariantAttributesUpdateActionsTest {
  ...
  void withSomeNullNewAttributesAndExistingAttributes_ShouldBuildActionsAndTriggerErrorCallback() {
    ...
    final List<Attribute> newAttributes = asList(BOOLEAN_ATTRIBUTE_TRUE, null);
    ...
    final AttributeDefinition booleanAttributeDefinition =
        AttributeDefinitionBuilder.of()
            .name(BOOLEAN_ATTRIBUTE_TRUE.getName())
    ...
    final AttributeDefinition textAttributeDefinition =
        AttributeDefinitionBuilder.of()
            .name(TEXT_ATTRIBUTE_BAR.getName())
            .label(ofEnglish("label"))
  ...
  void withAllMatchingAttributes_ShouldNotBuildActions() {
    ...
    final String variantKey = "foo";
    when(oldProduct.getKey()).thenReturn(productKey);
    final List<Attribute> newAttributes = asList(BOOLEAN_ATTRIBUTE_TRUE, TEXT_ATTRIBUTE_BAR);
    when(newProductVariant.getAttributes()).thenReturn(newAttributes);
    when(newProductVariant.getKey()).thenReturn(variantKey);
  ...
  void withSomeNonChangedMatchingAttributesAndNewAttributes_ShouldBuildSetAttributeActions() {
    ...
    final List<Attribute> newAttributes =
        asList(BOOLEAN_ATTRIBUTE_TRUE, TEXT_ATTRIBUTE_BAR, TIME_ATTRIBUTE_10_08_46);
    when(newProductVariant.getAttributes()).thenReturn(newAttributes);
    when(newProductVariant.getKey()).thenReturn(variantKey);
    ...
    final AttributeDefinition timeAttributeDefinition =
        AttributeDefinitionBuilder.of()
            .name(TIME_ATTRIBUTE_10_08_46.getName())
            .label(ofEnglish("label"))
    ...
    assertThat(updateActions)
        .containsExactly(
            ProductSetAttributeActionBuilder.of()
                .variantId(oldProductVariant.getId())
                .name(TIME_ATTRIBUTE_10_08_46.getName())
                .value(TIME_ATTRIBUTE_10_08_46.getValue())
                .staged(true)
                .build());
  }
  ...
  void withSomeNonChangedMatchingAttributesAndNoNewAttributes_ShouldBuildUnSetAttributeActions() {
    ...
    final String variantKey = "foo";
    when(oldProduct.getKey()).thenReturn(productKey);
    final List<Attribute> newAttributes = singletonList(BOOLEAN_ATTRIBUTE_TRUE);
    when(newProductVariant.getAttributes()).thenReturn(newAttributes);
    when(newProductVariant.getKey()).thenReturn(variantKey);
    ...
    assertThat(updateActions)
        .containsExactlyInAnyOrder(
            ...
            ProductSetAttributeActionBuilder.of()
                .variantId(oldProductVariant.getId())
                .name(BOOLEAN_ATTRIBUTE_TRUE.getName())
                .value(BOOLEAN_ATTRIBUTE_TRUE.getValue())
                .staged(true)
                .build());
  }
  ...
  void withAllChangedMatchingAttributes_ShouldBuildSetActions() {
    ...
    final String variantKey = "foo";
    when(oldProduct.getKey()).thenReturn(productKey);
    final List<Attribute> newAttributes = asList(BOOLEAN_ATTRIBUTE_TRUE, TEXT_ATTRIBUTE_FOO);
    when(newProductVariant.getAttributes()).thenReturn(newAttributes);
    when(newProductVariant.getKey()).thenReturn(variantKey);
    ...
    assertThat(updateActions)
        .containsExactlyInAnyOrder(
            ProductSetAttributeActionBuilder.of()
                .variantId(oldProductVariant.getId())
                .name(TEXT_ATTRIBUTE_FOO.getName())
                .value(TEXT_ATTRIBUTE_FOO.getValue())
                .staged(true)
                .build(),
            ProductSetAttributeActionBuilder.of()
                .variantId(oldProductVariant.getId())
