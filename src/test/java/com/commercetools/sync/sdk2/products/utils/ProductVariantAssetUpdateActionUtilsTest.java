...
import static com.commercetools.sync.products.utils.ProductVariantAssetUpdateActionUtils.*;
...
class ProductVariantAssetUpdateActionUtilsTest {
    ...
    assertThat(updateActions)
        .containsExactlyInAnyOrder(
            ...
            SetAssetCustomField.ofVariantIdUsingJsonAndAssetKey(
                1, null, "invisibleInShop", newCustomFieldsMap.get("invisibleInShop"), true),
            SetAssetCustomField.ofVariantIdUsingJsonAndAssetKey(
                1, null, "backgroundColor", newCustomFieldsMap.get("backgroundColor"), true));
  }
  ...
  void buildCustomUpdateActions_WithNullOldStagedValues_ShouldBuildUpdateAction() {
    ...
    assertThat(updateActions)
        .containsExactly(
            SetAssetCustomType.ofVariantIdAndAssetKey(
                1, newAssetDraft.getKey(), newCustomFieldsDraft, true));
  }
