...
import static com.commercetools.sync.sdk2.products.utils.UpdateActionsSortUtils.sortPriceActions;
...
class UpdateActionsSortUtilsTest {
  ...
  void sortPriceActionsTest(
    ...
    final List<ProductUpdateAction> result = sortPriceActions(updateActions);
   ...
   * anticommutation - exception symmetry - transitivity - consistency with <code>equals</code>.
   *
  ...
  private static Stream<Arguments> sortPriceActionsTestCases() {
    ...
    final ProductUpdateAction changePrice =
        ProductChangePriceActionBuilder.of()
            .priceId("1")
            .price(DRAFT_NE_777_EUR_05_07)
            .staged(true)
            .build();
    final ProductUpdateAction changePrice2 =
        ProductChangePriceActionBuilder.of()
            .priceId("2")
            .price(DRAFT_NE_777_EUR_05_07)
            .staged(true)
            .build();
    final ProductUpdateAction addPrice =
        ProductAddPriceActionBuilder.of().variantId(1L).price(DRAFT_NE_777_EUR_05_07).build();
    final ProductUpdateAction addPrice2 =
        ProductAddPriceActionBuilder.of().variantId(2L).price(DRAFT_NE_777_EUR_05_07).build();
    final ProductUpdateAction removePrice =
        ProductRemovePriceActionBuilder.of().priceId("1").build();
    final ProductUpdateAction removePrice2 =
        ProductRemovePriceActionBuilder.of().priceId("2").build();
    ...
    return Stream.of(
        ...
        Arguments.of(
            case9,
            asList(removePrice, changePrice, addPrice),
            asList(removePrice, changePrice, addPrice)),
        Arguments.of(
            case10,
            asList(removePrice, addPrice, changePrice),
            asList(removePrice, changePrice, addPrice)),
        Arguments.of(
            case11,
            asList(addPrice, changePrice, removePrice),
            asList(removePrice, changePrice, addPrice)),
        Arguments.of(
            case12,
            asList(addPrice, removePrice, changePrice),
            asList(removePrice, changePrice, addPrice)),
        Arguments.of(
            case13,
            asList(changePrice, removePrice, addPrice),
            asList(removePrice, changePrice, addPrice)),
        Arguments.of(
            case14,
            asList(changePrice, addPrice, removePrice),
            asList(removePrice, changePrice, addPrice)),
        ...
        Arguments.of(
            case27,
            asList(removePrice, changePrice2, addPrice),
            asList(removePrice, changePrice2, addPrice)),
        Arguments.of(
            case28,
            asList(removePrice, addPrice, changePrice2),
            asList(removePrice, changePrice2, addPrice)),
        Arguments.of(
            case29,
            asList(addPrice, changePrice2, removePrice),
            asList(removePrice, changePrice2, addPrice)),
        Arguments.of(
            case30,
            asList(addPrice, removePrice, changePrice2),
            asList(removePrice, changePrice2, addPrice)),
        Arguments.of(
            case31,
            asList(changePrice2, removePrice, addPrice),
            asList(removePrice, changePrice2, addPrice)),
        Arguments.of(
            case32,
            asList(changePrice2, addPrice, removePrice),
            asList(removePrice, changePrice2, addPrice)));
  }
}
