...
import static com.commercetools.sync.sdk2.shoppinglists.helpers.LineItemReferenceResolver.FAILED_TO_RESOLVE_CUSTOM_TYPE;
...
class LineItemReferenceResolverTest {
  ...
  void resolveReferences_WithCustomTypeId_ShouldNotResolveCustomTypeReferenceWithKey() {
    ...
    final LineItemDraft lineItemDraft =
        LineItemDraftBuilder.of().sku("dummy-sku").quantity(10L).custom(customFieldsDraft).build();
