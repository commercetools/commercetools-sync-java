...
class TaxCategoryServiceImplIT {
    ...
    void fetchCachedTaxCategoryId_WithNonExistingTaxCategory_ShouldNotFetchATaxCategory() {
        final Optional<String> taxCategoryId = taxCategoryService
    ...
    void fetchMatchingTaxCategoriesByKeys_WithAllExistingSetOfKeys_ShouldCacheFetchedTaxCategoryIds() {
        final Set<TaxCategory> fetchedTaxCategories = taxCategoryService
    ...
    void createTaxCategory_WithDuplicateKey_ShouldHaveEmptyOptionalAsAResult() {
        //preparation
        final TaxCategoryDraft newTaxCategoryDraft = TaxCategoryDraftBuilder
            .of(TAXCATEGORY_NAME_1, singletonList(createTaxRateDraft()), TAXCATEGORY_DESCRIPTION_1)
            .key(TAXCATEGORY_KEY)
            .build();
