...
class ProductSyncWithAssetsIT {
  ...
  //    customFieldsJsonMap.put(BOOLEAN_CUSTOM_FIELD_NAME,
  ...
  //                    createVariantDraft(
  //                        "masterVariant", assetDraftsToCreateOnExistingProductOnSourceProject,
  // null))
  //            .key(productKey)
  //            .build();
  //    CTP_SOURCE_CLIENT
  ...
  //
  //    final List<ProductDraft> productDrafts =
  //        ProductTransformUtils.toProductDrafts(CTP_SOURCE_CLIENT, referenceIdToKeyCache,
  // products)
  //            .join();
  //
  //    final ProductSyncStatistics syncStatistics =
