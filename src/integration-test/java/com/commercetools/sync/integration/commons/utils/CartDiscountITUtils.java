...
public class CartDiscountITUtils {
    ...
    public static final String CART_DISCOUNT_KEY_4 = "key4";
    ...
    public static final CartPredicate CART_DISCOUNT_CART_PREDICATE_1 = CartPredicate.of("1 = 1");
    public static final CartPredicate CART_DISCOUNT_CART_PREDICATE_2 =
        CartPredicate.of("lineItemExists(sku = \"0123456789\" or sku = \"0246891213\") = true");
    public static final CartPredicate CART_DISCOUNT_CART_PREDICATE_3 = CartPredicate.of("totalPrice >= \"100 EUR\"");
    public static final CartPredicate CART_DISCOUNT_CART_PREDICATE_4 =
        CartPredicate.of("totalPrice >= \"20.00 EUR\" and (shippingInfo.shippingMethodName = \"FEDEX\")");
    ...
    private static final CartDiscountDraft cartDiscountDraft1 =
    ...
    private static final CartDiscountDraft cartDiscountDraft2 =
    ...
    private static final CartDiscountDraft cartDiscountDraft3 =
    ...
    public static void populateSourceProject() {
        CTP_SOURCE_CLIENT.execute(CartDiscountCreateCommand.of(cartDiscountDraft1)).toCompletableFuture().join();
        CTP_SOURCE_CLIENT.execute(CartDiscountCreateCommand.of(cartDiscountDraft2)).toCompletableFuture().join();
    }

    public static void populateTargetProject() {
        CTP_TARGET_CLIENT.execute(CartDiscountCreateCommand.of(cartDiscountDraft1)).toCompletableFuture().join();
    }
