...
import static com.commercetools.sync.integration.sdk2.commons.utils.StateITUtils.deleteStates;
import static com.commercetools.sync.integration.sdk2.commons.utils.TaxCategoryITUtils.deleteTaxCategories;
...
public final class ProductITUtils {
  ...
  public static void deleteProductSyncTestData(@Nonnull final ProjectApiRoot ctpClient) {
    ...
    deleteStates(ctpClient, null);
    deleteTaxCategories(ctpClient);
    deleteCustomerGroups(ctpClient);
    deleteCustomers(ctpClient);
    deleteWaitingToBeResolvedCustomObjects(ctpClient, CUSTOM_OBJECT_PRODUCT_CONTAINER_KEY);
  }
