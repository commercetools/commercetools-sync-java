package com.commercetools.sync.integration.sdk2.externalsource.categories.utils;
...
class CategoryReferenceResolutionUtilsIT {
  ...
  void buildCategoryQuery_Always_ShouldFetchProductWithoutExpansionOnReferences() {
    ...
    ensureCategoriesCustomType(OLD_CATEGORY_CUSTOM_TYPE_KEY, ENGLISH, "anyName", CTP_TARGET_CLIENT);
