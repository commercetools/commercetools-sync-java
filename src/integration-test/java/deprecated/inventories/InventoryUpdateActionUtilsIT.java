...
import static deprecated.inventories.utils.InventoryITUtils.CUSTOM_FIELD_NAME;
import static deprecated.inventories.utils.InventoryITUtils.CUSTOM_TYPE;
...
class InventoryUpdateActionUtilsIT {
  ...
  void buildCustomUpdateActions_ShouldBuildActionThatSetCustomField() {
    ...
    final CustomFieldsDraft customFieldsDraft =
        CustomFieldsDraftBuilder.ofTypeId(oldInventoryBeforeSync.getCustom().getType().getId())
            .addObject(CUSTOM_FIELD_NAME, CUSTOM_FIELD_VALUE)
            .build();
    final InventoryEntryDraft newInventory =
        InventoryEntryDraft.of(
    ...
    final List<UpdateAction<InventoryEntry>> updateActions =
        buildPrimaryResourceCustomUpdateActions(
            oldInventoryBeforeSync, newInventory, new InventoryCustomActionBuilder(), options);
    ...
    assertThat(oldEntryAfterSync.getCustom().getFieldAsString(CUSTOM_FIELD_NAME))
        .isEqualTo(CUSTOM_FIELD_VALUE);
  }
}
