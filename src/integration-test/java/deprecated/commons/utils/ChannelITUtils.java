...
public final class ChannelITUtils {
  ...
  /**
   * Creates a {@link Channel} in the CTP project defined by the {@code ctpClient} in a blocking
   * fashion.
   *
  ...
  public static Channel createChannel(
    ...
    final ChannelDraft channelDraft = ChannelDraftBuilder.of(name).key(key).build();
