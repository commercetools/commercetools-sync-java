...
class ProductSyncWithReferencedCategoriesIT {
  ...
  void sync_withCategoryReferenceAsAttribute_shouldCreateProductReferencingExistingCategory() {
    ...
    final AttributeDraft categoryReferenceAttribute =
        AttributeDraft.of(
            "category-reference", Reference.of(Category.referenceTypeId(), category.getKey()));
  ...
  void
    ...
    final AttributeDraft newCategoryReferenceAttribute =
        AttributeDraft.of(
            "category-reference", Reference.of(Category.referenceTypeId(), category2.getKey()));
    final ProductVariantDraft newMasterVariant =
        ProductVariantDraftBuilder.of()
            .sku("sku")
            .key("new-product-master-variant")
    ...
    final AttributeDraft expectedAttribute =
        AttributeDraft.of(
            "category-reference", Reference.of(Category.referenceTypeId(), category2.getId()));
  ...
  void sync_withNonExistingCategoryReferenceAsAttribute_ShouldFailCreatingTheProduct() {
    ...
    final AttributeDraft categoryReferenceAttribute =
        AttributeDraft.of(
            "category-reference", Reference.of(Category.referenceTypeId(), "nonExistingKey"));
    final ProductVariantDraft masterVariant =
        ProductVariantDraftBuilder.of()
            .sku("sku")
            .key("new-product-master-variant")
